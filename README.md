...
- `market_data.xlsx`: The input dataset containing historical daily closing prices.

## Skills Demonstrated
- **Financial Risk Management:** Understanding and calculating VaR at specific confidence intervals (95%/99%).
- **Technical Analysis:** Using Python (`Pandas`, `NumPy`, `SciPy`) to process financial time-series data.
